...
const Home = () => {
  ...
  return (
    <div className='flex flex-col lg:flex-row items-center justify-center lg:justify-start min-h-screen w-full bg-black'>
      ...
      <div className='bg-slate-900 shadow-lg shadow-slate-800 h-[32vh] w-[90vw] md:w-[60vw] lg:w-[64vh] border-spacing-2 rounded-lg flex flex-col items-center justify-center p-6 lg:ml-[350px]'>
